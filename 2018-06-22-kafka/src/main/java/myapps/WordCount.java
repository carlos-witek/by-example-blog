...
public class WordCount {
	...
	public static void main( String[] args ) throws Exception {
		...
		final KStream<String, String> source = builder
				.<String, String> stream( "streams-plaintext-input" );

		final KStream<String, String> stage1 = source
				.flatMapValues( value -> Arrays.asList( value.toLowerCase().split( "\\W+" ) ) );

		final KGroupedStream<String, String> stage2 = stage1.groupBy( ( key, value ) -> value );

		final KTable<String, Long> stage3 = stage2.count(
				Materialized.<String, Long, KeyValueStore<Bytes, byte[]>> as( "counts-store" ) );

		final KStream<String, Long> stage4 = stage3.toStream();

		stage4.to( "streams-wordcount-output", Produced.with( Serdes.String(), Serdes.Long() ) );
